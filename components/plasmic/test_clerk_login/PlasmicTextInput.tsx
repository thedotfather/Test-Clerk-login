...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: l9bvO8Lp_BTE/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg___9Lhr)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg___7Uly)}
              role={"img"}
            />
          ),
